...
| "Reducing phone minutes is the measurable part. Changing learning is the work that follows." | Beland & Murphy, *Labour Economics* 41 (2016), 61–76, found gains concentrated in the lowest achievers with no significant effect on high achievers; Goodyear et al., *The Lancet Regional Health – Europe* 51 (2025), 101211 (SMART Schools), found reduced in-school phone use but no significant difference in wellbeing or attainment; a 2024 scoping review of 22 studies called the evidence inconclusive |
